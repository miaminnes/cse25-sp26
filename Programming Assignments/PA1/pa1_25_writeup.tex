...
\begin{itemize}[leftmargin=1.25em]
  \item Submit \texttt{PA1\_starter.ipynb} with all TODOs completed.
  \item Submit the notebook as an \texttt{.ipynb} file, not as a PDF.
  \item Do not rename the notebook; submissions with a different filename may fail in the autograder.
\end{itemize}
...
\section*{Notes}
\begin{itemize}[leftmargin=1.25em]
  \item Train/test split (provided utility) and Part 4.3 (plotting) are provided.
  \item The autograded portion of PA1 is worth 95 points total.
  \item Autograder points are split into 50 public points and 45 private points.
